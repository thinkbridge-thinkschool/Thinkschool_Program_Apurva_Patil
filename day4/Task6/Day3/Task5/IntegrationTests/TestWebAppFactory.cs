...
public class TestWebAppFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            // so an expired-by-seconds token is reliably rejected.
            ...
            // All test tokens have issuer "your-app", so the smart scheme
            // always routes them to InternalJwt; Entra is never invoked.
            services.PostConfigure<JwtBearerOptions>("Entra", options =>
            {
                ...
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    // Accept any well-formed JWT without verifying the signature,
                    // but since no test token has an Entra issuer this path is
