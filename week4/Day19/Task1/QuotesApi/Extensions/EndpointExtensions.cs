...
public static class EndpointExtensions
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // Day 18 in-memory channel — notifies QuoteNotificationService locally.
        // Service Bus (Day 19) handles durable order processing separately.
        notificationChannel.Writer.TryWrite(createdQuote.Id);
